...
const UICountryField = (props) => {
    ...
    return (
        <div className={`field ${props.className}`}>
            ...
            <Dropdown placeholder="Select Country" fluid search selection options={countryOptions} value={props.value} defaultValue={props.defaultValue} onChange={props.onChange}  />
        </div>
    );
};

export default UICountryField;
